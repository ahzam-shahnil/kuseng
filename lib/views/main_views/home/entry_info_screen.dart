...
import 'package:kuseng/views/main_views/home/survey_screen.dart';
        ...
        child: ListView(
          children: [
            ...
            SquareContainer(
              ...
              onTap: () {
                Get.to(() => const SurveyScreen(),  transition: Transition.native);
              },
            ),
            SizedBox(
              height: Get.size.height * 0.05,
            ...
            SquareContainer(
              ...
              onTap: () {
                Get.to(() => const SelfieScreen(),  transition: Transition.native);
              },
            ),
          ],
        ),
